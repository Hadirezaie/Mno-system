...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sim-pairs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SIMPAIRS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SIMPAIRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SIMPAIRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SIMPAIRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SIMPAIRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SIMPAIRS actions', async () => {
      const expectedActions = [
        {
