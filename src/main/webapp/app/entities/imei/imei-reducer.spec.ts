...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './imei.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMEI_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMEI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMEI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMEI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMEI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMEI actions', async () => {
      const expectedActions = [
        {
